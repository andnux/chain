...
import top.andnux.chain.eos.api.RpcService;
...
import top.andnux.chain.eos.client.exception.InvalidParameterException;
import top.andnux.chain.eos.client.http.Generator;
import top.andnux.chain.eos.client.pack.PackUtils;
import top.andnux.chain.eos.client.transaction.SignedTransactionToPush;
import top.andnux.chain.eos.client.transaction.TransactionBuilder;
...
public class Eos4j {
	...
	public String calcTransactionId(Transaction transaction) {
		...
		return Hex.bytesToHexString(Sha256.sha256(bf.getBuffer()));
	}
